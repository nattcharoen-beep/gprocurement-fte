...
export const BATCHES = [
  ...
  },
  {
    ...
    keywords: ['ตู้สายฉีดน้ำดับเพลิง', 'ตู้ดับเพลิง', 'สายส่งน้ำดับเพลิง', 'หัวรับน้ำดับเพลิง', 'ท่อดับเพลิง']
  },
  {
...
export const EXCLUDE_TERMS = [
  'ยางมะตอย', 'ถนนลาดยาง', 'จัดเก็บขยะ', 'รถบรรทุกขยะ', 'รถดูดสิ่งปฏิกูล', 'แม่บ้าน',
  'ทำความสะอาดทั่วไป', 'เปลี่ยนยางรถยนต์', 'ปะยาง', 'น้ำมันเครื่อง', 'อาหารกลางวัน', 'จัดเลี้ยง',
  'จัดประชุมสัมมนา', 'ตัดหญ้า', 'ถมดิน', 'ยาเวชภัณฑ์', 'ถุงมือแพทย์', 'เตียงผู้ป่วย'
];
...
async function runBatchDirect(batchName, keywords, lookbackDateStr, todayStr, tokenManager, budgetYears = ['2569']) {
  ...
  for (const [pid, cand] of candidates.entries()) {
    ...
    verified.push({
      ...
      province: extractProvince(cand.deptName, cand.title, latestRow.rdbProvinceMoiName || cand.province),
